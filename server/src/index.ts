...
app.post('/api/mt5/forex-scalper/backtest', async (req, res) => {
    try {
        const config = {
            ...
            gridDistancePoints: req.body.gridDistancePoints || 30,
            maxGridLevels: req.body.maxGridLevels || 5,
            takeProfitPoints: req.body.takeProfitPoints || 50,
            stopLossPoints: req.body.stopLossPoints || 75,
            smartBreakevenEnabled: req.body.smartBreakevenEnabled ?? true,
            smartBreakevenTriggerPoints: req.body.smartBreakevenTriggerPoints || 30,
            smartBreakevenLockPoints: req.body.smartBreakevenLockPoints || 5,
            trailingStopEnabled: req.body.trailingStopEnabled ?? true,
            trailingStopPoints: req.body.trailingStopPoints || 20,
            basketSize: req.body.basketSize || 3,
            basketOffsetPoints: req.body.basketOffsetPoints || 20,
            basketTPMultiplier: req.body.basketTPMultiplier || 2.0,
